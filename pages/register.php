...
<h1>Register</h1>
	<form class="regform" action="index.php?p=register" method="post">
        ...
        <h3>Last Name</h3>
            <input type = "text" class = "bookingInput" name = "lname" placeholder = "Enter Last Name">
        <h3>Phone Number</h3>
            <input type = "text" class = "bookingInput" name = "phone" placeholder = "Enter Phone Number">
        <h3>Email</h3>
            <input type = "email" class = "bookingInput" name = "email" placeholder = "Enter Email Address">
        <h3>Password</h3>
            <input type = "password" class = "bookingInput" name = "password" placeholder = "Enter Password">
